...
# Create DirectController in rallyrobopilot
cat > rallyrobopilot/direct_controller.py << 'EOF'
"""
...
class DirectController:
    ...
    def reset_to_state(self, position, angle, speed=0.0):
        """
        ...
        Args:
            ...
            speed (float): Initial speed (default 0)
        """
        ...
        # Set speed after reset (if needed)
...
echo "✓ Created rallyrobopilot/direct_controller.py"